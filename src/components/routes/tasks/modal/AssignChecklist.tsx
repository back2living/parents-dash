...
const Task = ({closeModal}: {closeModal: () => void}) => {
    ...
    return (
        <div>
            <ModalTop title={"Assign checklist"} Icon={CloseIcon} closeModal={closeModal} />

            <div className={"modal-content flex-column gap-6"}>
                <div>
                    <label className={"auth-label text-primary"} htmlFor="">Checklist categories</label>
                    <div>
                ...
                <div>
                    <label className={"auth-label text-primary"} htmlFor="">Assign Checklist</label>
                    <div>
                        <Listbox value={selected} onChange={setSelected}>
                            <div className="relative">
