    ...
    return (
        <div className="p-2 min-w-[300px] w-[26.3%] rounded-xl max-w-[310px] bg-white overflow-auto hidden lg:block">
            ...
            <div className={"flex-column gap-2 font-medium"}>
                {data?.map((kid, index: number) => <div key={kid._id} onClick={() => handleKidClick(kid, index)} className={activeKidTab?._id === kid._id ? categoryStyle.active : categoryStyle.inactive}>
