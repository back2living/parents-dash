...
const EditChecklist = ({closeModal}: { closeModal: () => void }) => {
    ...
    return (
        <div className={"relative"}>
            ...
            <div className={"modal-content flex-column gap-6"}>
                <div>
                    <label className={"auth-label text-primary"} htmlFor="">Checklist Icon</label>
                    <div>
                ...
                <div className={"flex-center lg:flex-row flex-col gap-4 lg:gap-6"}>
