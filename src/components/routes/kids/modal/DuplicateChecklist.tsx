...
const DuplicateChecklist = ({closeModal}: { closeModal: () => void }) => {
    const [selected, setSelected] = useState(null);
    const [isTaskFocused, setIsTaskFocused] = useState(false);
    return (
        <div className={"relative"}>
            <ModalTop title={"Duplicate checklist"} Icon={CircleCloseIcon} closeModal={closeModal}/>
            ...
            <div className={"modal-content flex-column gap-6"}>
                ...
                <div>
                    <label className={"auth-label text-primary"} htmlFor="">Duplicate to</label>
                    <div>
                ...
                <div className={"flex gap-6"}>
                    ...
                    <button className={"primary-btn"}>Duplicate</button>
                </div>
            </div>
        </div>
    );
